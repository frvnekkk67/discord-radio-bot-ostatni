...
from utils.player import resolve_playlist_queries, LavalinkUnavailableError, EQ_PRESETS, normalize_audio_url
...
class Music(commands.Cog):
    ...
    async def graj(self, interaction: discord.Interaction, zapytanie: str):
        ...
        player.add_to_queue(normalize_audio_url(zapytanie))
    ...
    async def nastepny(self, interaction: discord.Interaction, zapytanie: str):
        ...
        try:
            ok = await player.play_now(normalize_audio_url(zapytanie))
        except LavalinkUnavailableError:
    ...
    async def eq(self, interaction: discord.Interaction, preset: app_commands.Choice[str]):
        ...
        player.default_eq_preset = preset.value
